...
//                            });
                    ...
                    function typeofSchool(schoolType) {
                        ...
                        for (i = 0; i < education.length; i++) {
                            if (education[i].CATEGORY == schoolType) {
                                ...
                                pushpin.metadata = {
                                    description: "<a href = ' " + education[i].WEBSITE + "' target = '_blank' > " + education[i].NAME + " </a><br> " +
                                        ...
                                        "Category : " + education[i].CATEGORY + "<br>" +
                                        "Community : " + education[i].COMMUNITY + "<br>" +
                                        "<a href='#' onclick='return direction(" + education[i].LATITUDE + "," + education[i].LONGITUDE + ");" + "'> Direction to School</a>"
